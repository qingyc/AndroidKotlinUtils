package com.qing.androidkotlinutils.core.base.dapter
...
class ItemDelegateManager<T> {
    ...
    fun getItemViewType(item: T, position: Int): Int {
        ...
        throw IllegalArgumentException(
                "No ItemDelegate added that matches position=$position in com.qing.androidkotlinutils.core.ext.getData source")
    }
    ...
    fun convert(holder: ViewHolder, item: T, position: Int) {
        ...
        throw IllegalArgumentException(
                "No ItemDelegateManager added that matches position=$position in com.qing.androidkotlinutils.core.ext.getData source")
    }
