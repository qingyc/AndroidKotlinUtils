...
public class ZipUtils {
     ...
     * @throws Exception
     */
    public static boolean UnZipFolder(InputStream inputstream,
                                      String outPathString) throws Exception {
        try {
            if (!outPathString.endsWith("/")) {
                outPathString += "/";
            }
            ...
            while ((zipEntry = inZip.getNextEntry()) != null) {
                ...
                if (zipEntry.isDirectory()) {
                    ...
                    QLogger.i(TAG, outPathString + szName);
                    File file = new File(outPathString + szName);
                    if (!file.exists()) {
                        QLogger.i(TAG, "Create the file:" + outPathString + szName);
    ...
    public static boolean UnZipFolder(String zipFileString,
                                      String outPathString,
                                      String szName) throws Exception {
        try {
            ZipInputStream inZip = new ZipInputStream(new FileInputStream(zipFileString));
            ZipEntry zipEntry;
            while ((zipEntry = inZip.getNextEntry()) != null) {
     ...
     * @throws Exception
     */
    private static void ZipFiles(String folderString,
                                 String fileString,
